...
![img](/img/softmax-mnist.assets/NOH}OC[SA3A%@29ALI$PL5.png)
...
![image-20210716000330267](/img/softmax-mnist.assets/image-20210716000330267.png)

下下来之后是个二进制文件, 下面介绍了二进制文件的构造.

![image-20210716000418636](/img/softmax-mnist.assets/image-20210716000418636.png)

这是训练集输入, 从第16B开始, 每一个字节代表一个像素, 一张图有784个像素, 一共有60000个图.

![image-20210716000503830](/img/softmax-mnist.assets/image-20210716000503830.png)
...
![2021-07-10](/img/softmax-mnist.assets/2021-07-10.png)

我猜这是个5.

然后按照输出的格式, 读取第8个字节.

![2021-07-10-1](/img/softmax-mnist.assets/2021-07-10-1.png)
...
![2021-07-15-3](/img/softmax-mnist.assets/2021-07-15-3.png)
...
![img](/img/softmax-mnist.assets/4RBM1{TIEEXFDV72[2GK4FI.jpg)
